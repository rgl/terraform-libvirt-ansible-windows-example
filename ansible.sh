...
install -d tmp
DOCKER_BUILDKIT=1 docker build -f Dockerfile --iidfile tmp/ansible-iid.txt .
...
#    see https://github.com/ansible/ansible-lint/blob/v25.12.1/src/ansiblelint/app.py#L106-L111
